        ...
        return [{
            ...
            'workspace': {
                ...
                'attributes': {
                    ...
                    'library:datatype': {
                        ...
                        'items': ['Whole Exome', 'Genotyping Array', 'RNA-Seq', 'miRNA-Seq',
                                  'Methylation Array', 'Protein Expression Array']
                    },
                    ...
                    'library:dataCategory': {
                        'itemsType': 'AttributeValue',
                        'items': ['Simple Nucleotide Variation', 'Copy Number Variation',
                        'Expression Quantification', 'DNA-Methylation', 'Clinical phenotypes', 'Biosample metadata']
                    },
                    ...
                    'library:datasetDescription': 'This cohort is part of The Cancer Genome Atlas project' +
                                                  ' (https://cancergenome.nih.gov/abouttcga/overview).' +
                                                  '  This cohort includes raw data and analysis of cancer' +
                                                  ' patients samples by genomic DNA copy number arrays, DNA' +
                                                  ' methylation, exome sequencing, mRNA arrays,' +
                                                  ' microRNA sequencing and reverse phase protein arrays.' +
                                                  ' De-identified patients’ clinical phenotypes and metadata' +
                                                  ' are also included. For more information see the full' +
                                                  ' TCGA cohorts publication list at:' +
                                                  ' https://cancergenome.nih.gov/publications;' +
                                                  ' Data description is also summarized at :' +
                                                  ' https://TCGA_data.nci.nih.gov/docs/publications//tcga/datatype.html'
                },
            ...
            'workspace': {
                ...
                'attributes': {
                    ...
                    'library:datatype': {
                        'itemsType': 'AttributeValue',
                        'items': ['Whole Exome', 'Genotyping Array', 'RNA-Seq',
                                  'miRNA-Seq', 'Methylation Array', 'Protein Expression Array']
                    },
                    ...
                    'library:dataCategory': {
                        'itemsType': 'AttributeValue',
                        'items': ['Simple Nucleotide Variation', 'Raw Sequencing data',
                                  'Copy Number Variation', 'Expression Quantification',
                                  'DNA-Methylation', 'Clinical phenotypes', 'Biosample metadata']
                    },
                    'library:dataFileFormats': {
                        'itemsType': 'AttributeValue',
                        'items': ['TXT', 'MAF', 'BAM']
                    ...
                    'library:useLimitationOption': 'skip',
                    'library:datasetDescription': 'This cohort is part of The Cancer Genome Atlas project' +
                                                  '(https://cancergenome.nih.gov/abouttcga/overview).  This cohort includes raw data and' +
                                                  ' analysis of cancer patients samples by genomic DNA copy number arrays,' +
                                                  ' DNA methylation, exome sequencing, mRNA arrays, microRNA sequencing and reverse phase' +
                                                  ' protein arrays. De-identified patients’ clinical phenotypes and' +
                                                  ' metadata are also included. For more information see the full TCGA' +
                                                  ' cohorts publication list at: https://cancergenome.nih.gov/publications; Data' +
                                                  ' description is also summarized at' +
                                                  ' : https://TCGA_data.nci.nih.gov/docs/publications//tcga/datatype.html'
                },
                'createdBy': 'adm.firec@gmail.com',
                'authDomainACLs': {
