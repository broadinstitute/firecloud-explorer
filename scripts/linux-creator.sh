...
./node_modules/.bin/electron-packager . --overwrite --asar --platform=linux --arch=x64 --icon=src/assets/icons/png/1024x1024.png --prune=true --out=app/linux/builds --app-copyright='Copyright © 2018 Broad Institute All Rights Reserved' --app-version='0.1.1'
